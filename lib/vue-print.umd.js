(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-print"] = factory();
	else
		root["vue-print"] = factory();
...
var print_checkOptions = function checkOptions(options) {
  if (!options.el) {
...
var prinf = function prinf(options) {
  var op = print_checkOptions(options);
  dom = op.el.cloneNode(true);
  var handle = createIframe(op);
...
var createIframe = function createIframe(op) {
  var debug = op.debug,
      importCss = op.importCss,
      importStyle = op.importStyle,
      loadCss = op.loadCss,
      title = op.title;
  removeIframe();
  ...
  var _iframe$contentDocume = iframe.contentDocument,
      body = _iframe$contentDocume.body,
      head = _iframe$contentDocume.head;
  var contentWindow = iframe.contentWindow; //插入head中的link stylesheet
  ...
  if (importStyle) {
    var _stylesheets = document.querySelectorAll("style");

    _stylesheets.forEach(function (item) {
...
/* harmony default export */ var print = (prinf);
// CONCATENATED MODULE: ./src/index.js


var src_install = function install(Vue) {
  Vue.prototype.$p = print;
};
...
//# sourceMappingURL=vue-print.umd.js.map